...
class CheckoutPage{
    constructor() { 
        ...
        this.nextShippingBtn = Selector("button[class='button-1 shipping-method-next-step-button']")
        this.nextPaymentBtn = Selector("button[class='button-1 payment-method-next-step-button']")
        this.nextConfirmBtn = Selector("button[class='button-1 payment-info-next-step-button']")
        this.confirmOrderBtn = Selector("button[class='button-1 confirm-order-next-step-button']")
